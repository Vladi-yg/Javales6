...
public class Cat extends Animals{
    ...
    public Cat(String color, String name, int maxjumpheight, boolean swimmskill, int swimmlenght, int distance, int maxrunlenght, int height) {
        super(color, name);
    ...
    public void getInfoCat() {
        ...
        } else  System.out.println("Cat can swimm");
    }
    public void run(){
        int runlenght = scanner.nextInt();
        distance = distance + runlenght;
        if (distance > maxrunlenght) {
            System.out.println("Cat can't run so long. Max distance is " + maxrunlenght);
        } else System.out.println("Cat has ran " + distance);
    }
    public void jump() {
        float jumpheight = scanner.nextFloat();
        height = height + jumpheight;
        if (height > maxjumpheight) {
            System.out.println("Cat can't jump so height. Max height is " + maxjumpheight + " meter");
        } else {
            System.out.println("Cat has jumped " + height);
        }
